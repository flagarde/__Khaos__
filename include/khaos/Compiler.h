...
// Put all compiler first then MSVC clang llvm gcc as some mimic others.
  ...
  #endif
  #define KHAOS_COMPILER_AltiumMicroblaze KHAOS_COMPILER_VERSION
    ...
    #define KHAOS_COMPILER_VERSION KHAOS_SET_VERSION((__VERSION__ / 1000) % 10, __VERSION__ % 1000, __REVISION__)
  #endif
  #define KHAOS_COMPILER_Altium KHAOS_COMPILER_VERSION
  ...
  #endif
  #define KHAOS_COMPILER_Borland KHAOS_COMPILER_VERSION
#elif defined(__CC65__)
  #define KHAOS_COMPILER_VERSION KHAOS_SET_VERSION((__CC65__ & 0xF00) >> 8, (__CC65__ & 0xF0) >> 4, (__CC65__ & 0xF))
  #define KHAOS_COMPILER_CC65    KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_Comeau  KHAOS_COMPILER_VERSION
  ...
  #endif
  #define KHAOS_COMPILER_Compaq KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_CrayC   KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_Diab    KHAOS_COMPILER_VERSION
#elif defined(_DICE)
  ...
  #define KHAOS_COMPILER_DigitalMars KHAOS_COMPILER_VERSION
  ...
  #endif
  #define KHAOS_COMPILER_GreenHills KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_IAR     KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_IBMClang      KHAOS_COMPILER_VERSION
  ...
  #endif
  #if defined(__xlc__)
    #define KHAOS_COMPILER_VERSION_TWEAK KHAOS_SET_VERSION_TWEAK((__xlc__ & 0xFF) % 100)
  #elif defined(__xlC_ver__)
    #define KHAOS_COMPILER_VERSION_TWEAK KHAOS_SET_VERSION_TWEAK((__xlC_ver__ & 0xFF) % 100)
  #endif
  #define KHAOS_COMPILER_IBM       KHAOS_COMPILER_VERSION
  #define KHAOS_COMPILER_IBMLegacy KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_IBM KHAOS_COMPILER_VERSION
    ...
    #define KHAOS_COMPILER_IBMMVS KHAOS_COMPILER_VERSION
  #elif __COMPILER_VER__ & 0xF0000000)>> 28 == 2
    #define KHAOS_COMPILER_IBMOS390 KHAOS_COMPILER_VERSION
  #elif __COMPILER_VER__ & 0xF0000000)>> 28 == 4
    #define KHAOS_COMPILER_IBMZOS KHAOS_COMPILER_VERSION
  #endif
  ...
  #endif
  #define KHAOS_COMPILER_Metrowerks KHAOS_COMPILER_VERSION
  ...
  #endif
  #define KHAOS_COMPILER_MIPSpro KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_Norcroft KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_Open64        KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_Oracle 1
    ...
    #endif
  #endif
  #define KHAOS_COMPILER_Solaris KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_Palm          KHAOS_COMPILER_VERSION
  ...
  #endif
  #define KHAOS_COMPILER_Renesas KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_Symantec KHAOS_COMPILER_VERSION
  ...
  #endif
  #define KHAOS_COMPILER_Think KHAOS_COMPILER_VERSION
  ...
  #define KHAOS_COMPILER_Watcom  KHAOS_COMPILER_VERSION
#elif defined(__ZTC__)
  #define KHAOS_COMPILER_VERSION KHAOS_SET_VERSION((__ZTC__ & 0xF00) >> 8, (__ZTC__ & 0xF0) >> 4, (__ZTC__ & 0xF))
  #define KHAOS_COMPILER_Zortech KHAOS_COMPILER_VERSION
  ...
  #endif
  #define KHAOS_COMPILER_GCC KHAOS_COMPILER_VERSION
#else
...
#define KHAOS_CLANG_EMULATED_VERSION_TWEAK KHAOS_SET_VERSION_TWEAK(0, 0, 0)
  ...
  #endif
  #define KHAOS_COMPILER_GCCEmulated KHAOS_GCC_EMULATED_VERSION
#else
